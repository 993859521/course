        ...
        methods: {
            uploadFile() {
                ...
                */
                ...
                let shardIndex = 1;		//分片索引，0表示第1个分片
                let size = file.size;
            ...
            check(param) {
                let _this = this;
                _this.$ajax.get(process.env.VUE_APP_SERVER + '/business/admin/file/check/' + param.key_md5).then((response) => {
            ...
            upload (param) {
                ...
                fileReader.onload = function (e) {
                    ...
                    _this.$ajax.post(process.env.VUE_APP_SERVER + '/business/admin/file/upload/', param).then((response) => {
                        let resp = response.data;

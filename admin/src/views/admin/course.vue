                    ...
                    <div class="thumbnail search-thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <div v-for="teacher in course.teacher" v-bind:title="teacher.intro" >
                                ...
                                <div >
                                    <strong class="chat-user">{{teacher.name}}</strong>
                                    <p class="m-b-xs">
                                        {{teacher.position}}
                                    </p>
                            ...
                            <p>
                                <span style="color:#0d8ddb;font-size:20px;">{{course.price}}&nbsp;<i class="fa fa-rmb"></i></span>&nbsp;
                            </p>
                            <p>{{course.summary}}</p>
                            <p>
                            ...
                            <p>
                                ...
                                <button v-on:click="openSortModal(course)"
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <p class="form-control-static">{{course.time}}</p>
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    export default {
        ...
        methods: {
            ...
            edit(course) {
                ...
                console.log(_this.course.teacherlist);

                ...
                <div class="container">
                    <div class="row course-head">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="course-head-item">
                                ...
                                <span style="padding-left: 1rem">{{COURSE_LEVEL | optionKV(course.level)}}</span>
                                <span style="padding-left: 1rem"><i class="fa fa-user"></i> {{course.enroll}}</span>
                            </p>
                    ...
                    <div class="row">
                      ...
                      <i v-show="!chapter.folded" class="fa fa-minus-square" aria-hidden="true"></i>
                        ...
                        <!-- 讲师信息 -->
                        <div class="col-md-3">
                            <div class="card" style="width: 18rem;" v-for="o in teacher">

                                <img v-bind:src="o.image" class="card-img-top">
                                <div class="card-body">
                                    <h5 class="card-title">{{o.name}}</h5>
                                    <p class="card-text">{{o.motto}}</p>
                                    <p class="card-text">{{o.intro}}</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                            ...
                            <video v-bind:src="setion_video" id="video" controls="controls" ></video>
...
<script>
    ...
    export default {
        ...
        methods: {
            findCourse() {
                let _this = this;
                _this.$ajax.get(process.env.VUE_APP_SERVER + '/web/course/find/' + _this.id).then((response)=>{

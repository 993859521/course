<template>
    <main role="main">
        <Header></Header>
        <div class="header-nav" STYLE="padding-top:5rem">
            <div class="clearfix">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
...
<script>
    import TheCourse from "../components/course";
    import Pagination from "../components/pagination";
    import Header from "../components/header";
    import Footer from "../components/footer";

    export default {
        components: {Footer, Header, Pagination, TheCourse},
        name: 'list',
        data: function () {
            return {
                courses: [],
        ...
        methods: {
            ...
            listCourse(page) {
                let _this = this;
                _this.$ajax.post(process.env.VUE_APP_SERVER + '/web/course/list', {
                    page: page,

    ...
    export default {
        ...
        methods:{
            ...
            save() {
                ...
                Loading.show();
                _this.$ajax.post(process.env.VUE_APP_SERVER+'/business/admin/${domain}/save/', _this. ${domain}).then((response)=>{
                    Loading.hide();
            ...
            del(id) {
                ...
                Confirm.show("删除大章后不可恢复，确认删除？", function () {
                    Loading.show();
                    _this.$ajax.delete( process.env.VUE_APP_SERVER+'/business/admin/${domain}/delete/' + id).then((response)=>{
                        Loading.hide();
                        let resp = response.data;
                        if (resp.success) {
                            _this.list(1);
